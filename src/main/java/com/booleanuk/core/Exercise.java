...
public class Exercise extends ExerciseBase {
    ...
    public int[] constructNumberArray(int lower, int upper){
        ...
        int[] intArray = IntStream.rangeClosed(lower, upper).toArray();
        return intArray;
    }
    ...
    /*
        ...
        error, 10   | ERROR!!!!!!!!!!
     */
    public String shout(String word, int numExclamationMarks){
        String shoutedWord = word.toUpperCase();
        for(int i = 0; i < numExclamationMarks; i++){
            shoutedWord += "!";
        }
        return shoutedWord;
    }
