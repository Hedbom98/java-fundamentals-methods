...
public class Extension extends ExtensionBase {
     ...
     */
    public int remainingBakeTime(int minInOven){
        return bakingTime() - minInOven;
    }
     ...
     */
    public int calculatePrepTime(int numLayers){
        return numLayers*3;
    }
     ...
     */
    public int totalTimeSpent(int numLayers, int minInOven){
        return calculatePrepTime(numLayers) + minInOven;
    }
